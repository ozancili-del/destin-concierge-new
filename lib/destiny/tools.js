...
async function fetchPartialWindows(arrival, departure) {
  ...
  try {
    const calRes = await fetch(
      `https://www.destincondogetaways.com/api/calendar?arrival=${arrival}&departure=${departure}`,
...
async function fetchPriceDrop(arrival, departure) {
  try {
    const res = await fetch(
      `https://www.destincondogetaways.com/api/price-drops?arrival=${arrival}&departure=${departure}`,
