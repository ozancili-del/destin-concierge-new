...
const tours = [
  { unit: "707", floor: "Seventh-floor Gulf-front condo", href: "/condos/unit-707", embed: "https://kuula.co/share/collection/7Xtss?logo=0&info=0&fs=1&vr=1&sd=1&initload=0&autorotate=-0.47&autopalt=1&thumbs=1" },
  { unit: "1006", floor: "Tenth-floor Gulf-front condo", href: "/condos/unit-1006", embed: "https://kuula.co/share/collection/7XtwX?logo=0&info=0&fs=1&vr=1&sd=1&initload=0&autorotate=-0.47&autopalt=1&thumbs=1" },
];

export default function VirtualToursPage() {
  const structuredData = { "@context": "https://schema.org", "@graph": [
    { "@type": "WebPage", "@id": `${liveSite}/virtual-tours#webpage`, url: `${liveSite}/virtual-tours`, name: "Pelican Beach Resort Condo Virtual Tours", description: "Walk through interactive 360-degree tours of owner-managed Pelican Beach Resort condos in Destin, Florida.", isPartOf: { "@id": `${liveSite}/#website` }, about: { "@id": `${liveSite}/#business` } },
    { "@type": "BreadcrumbList", itemListElement: [{ "@type": "ListItem", position: 1, name: "Home", item: liveSite }, { "@type": "ListItem", position: 2, name: "Virtual Tours", item: `${liveSite}/virtual-tours` }] },
