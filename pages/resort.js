...
export default function Resort() {
  ...
  return <div className={styles.page}>
    ...
    <main>
      ...
      <section className={styles.condos} id="condos"><div className={styles.sectionHead}><p className={styles.kicker}>Gulf-front vacation rentals</p><h2>Choose the exact view and style you prefer.</h2><p>Each one-bedroom, two-bath condo sleeps up to six, with a full kitchen, high-speed Wi-Fi, smart TVs, a private balcony and beach gear.</p></div><div className={styles.condoGrid}><article><img src="/images/site/0f604abce3284748ba8d2150b7646863-large.webp" alt="Unit 707 Gulf-view balcony at Pelican Beach Resort" /><div><span>Seventh floor</span><h3>Unit 707</h3><p>Classic coastal style with a Gulf-front balcony and sunset views.</p><SiteButton href="/condos/unit-707" variant="secondary">Explore Unit 707</SiteButton></div></article><article><img src="/images/site/79fb2b20887c4f44b58c710a59420a30-large.webp" alt="Unit 1006 panoramic Gulf view at Pelican Beach Resort" /><div><span>Tenth floor</span><h3>Unit 1006</h3><p>Fresh coastal style with a higher panoramic view over the Gulf.</p><SiteButton href="/condos/unit-1006" variant="secondary">Explore Unit 1006</SiteButton></div></article></div></section>

      <section className={styles.visualSplit}><img src="/images/site/44060a8a29ca4a998586d849184d288f-large.webp" alt="Emerald Coast shoreline beside Pelican Beach Resort in Destin Florida" /><div><p className={styles.kicker}>A practical Emerald Coast base</p><h2>Stay on the Gulf and build the rest of Destin around it.</h2><p>Guests often choose this part of Destin because the beach can remain the default plan while the harbor, restaurants, shopping and family attractions stay within a short drive. That matters on a mixed-weather trip: a morning at the Gulf can become lunch, an indoor stop or a harbor evening without relocating to another part of the coast.</p><p>Summer brings the warmest water and the largest crowds. Spring and fall can offer milder weather, while winter appeals to longer-stay visitors who value the Gulf view and central location more than daily swimming. Conditions, beach flags, water temperature and event schedules change, so use the linked live guides instead of treating a seasonal description as a forecast.</p><p>For planning beyond the resort, review the <a href="/blog/destinweather">Destin weather and Gulf guide</a>, browse the <a href="/blog/best-restaurants-destin">local restaurant guide</a>, or create a <a href="/trip-planner">personalized day-by-day itinerary</a>.</p></div></section>
