...
export default function DestinAirportGuide() {
  ...
  return <MigratedBlogArticle pageTitle="Live Destin Airport Guide | VPS, ECP & PNS" description={article.description} structuredData={structuredData} heroImage="/airport-terminal-sunset.png" heroAlt="Airport terminal near Destin Florida at sunset" kicker="Arrive with less guesswork" title="Destin Airport Guide" intro="Compare VPS, ECP and PNS, follow the route to Pelican Beach Resort, and check live arrival and departure boards." articleHtml={article.html} related={[
