<meta name="google-site-verification" content="p6BjtVEdGbH1bDdR5ie_97pFM4M-Hdz45q2JFXtAlQI" />
<script>
...
wrap.id='db-bubble';
wrap.innerHTML=`<div id="db-window"><div id="db-header"><img src="https://destin-concierge-new.vercel.app/destiny_avatar.png" style="width:52px;height:52px;border-radius:50%;object-fit:cover;object-position:top;flex-shrink:0;"/><div id="db-header-text"><div id="db-header-name">Destiny Blue</div><div id="db-header-sub"><span class="db-status-dot"></span>AI Concierge · Always here</div></div><button id="db-mobile-close" aria-label="Close">✕</button></div><div id="db-messages"></div><div id="db-input-row"><input id="db-input" type="text" placeholder="Ask me anything…" autocomplete="off"/><button id="db-send"><svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M22 2L11 13M22 2L15 22L11 13M22 2L2 9L11 13" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg></button></div><div id="db-footer">Powered by Destiny Blue · © Ozan CILI</div></div><div id="db-tooltip">Hi! Ask me anything about Destin!</div><button id="db-btn" aria-label="Chat"><div id="db-badge"></div><img class="db-icon-open" src="https://destin-concierge-new.vercel.app/destiny_avatar.png" style="width:60px;height:60px;border-radius:50%;object-fit:cover;object-position:top;display:block;"/><svg class="db-icon-close" width="22" height="22" viewBox="0 0 24 24" fill="none"><path d="M18 6L6 18M6 6L18 18" stroke="white" stroke-width="2.5" stroke-linecap="round"/></svg></button>`;
document.body.appendChild(wrap);
const overlay=document.createElement('div');
overlay.id='db-overlay';
overlay.innerHTML=`<div id="db-pop"><button class="dx" id="db-pop-x">✕</button><img src="https://destin-concierge-new.vercel.app/destiny_avatar.png"/><div class="ptxt"><p class="pname">Destiny Blue 🌊</p><p class="pmsg">You get <strong style="color:white">10% off</strong> automatically. Chat with me and unlock <strong style="color:white">5% more</strong> on top.</p><button class="pbtn" id="db-pop-go">Treasure Hunt! →</button></div></div>`;
