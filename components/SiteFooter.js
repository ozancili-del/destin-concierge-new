...
export default function SiteFooter() {
  return <footer className={styles.footer}>
    ...
    <div><strong>Guest Information</strong><a href="/guest-guide#policies">Policies</a><a href="/guest-guide#faq">FAQ</a><a href="/about">About &amp; contact</a><a href="/privacy">Privacy</a><a href={`${liveSite}/map`}>Destin map</a><a href="/beach-cam">Live beach cam</a></div>
