...
function bookingInputFromArgs(args, context, { allowZeroChildBaseline = false } = {}) {
  ...
  return { dates, adults, children, totalGuests, preferredUnit, bedroomsRequested, explicitAdults, explicitChildren, explicitTotalGuests, assumedChildrenZero, dateText };
}
