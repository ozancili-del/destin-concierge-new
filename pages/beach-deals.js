    ...
    <>
      ...
      <style jsx global>{`
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .sbux-tag-img { position:absolute; bottom:44px; right:8px; z-index:3; width:clamp(110px,28%,160px); pointer-events:none; filter:drop-shadow(0 6px 14px rgba(0,0,0,0.6)); }
