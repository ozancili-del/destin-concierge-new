const exactRoutes = new Map([
  ...
  ["/pelican-beach-resort-destin-574048693", "/resort"],
  ["/-pelican-beach-resort-condo-rental-574046950", "/why-book-direct"],
  ["/pelican-beach-resort-unit-707-orp5b47b5ax", "/condos/unit-707"],
  ["/pelican-beach-resort-unit-1006-orp5b6450ex", "/condos/unit-1006"],
  ["/destin-live-beach-cam-574002656", "/beach-cam"],
  ["/destin-vacation-itinerary-planner-574049367", "/trip-planner"],
  ["/ai-concierge-574036277", "/destin-ai-concierge"],
  ["/virtualtour-574001044", "/virtual-tours"],
  ["/destin-condo-guide-574047967", "/faq"],
...
const hostRoutes = new Map([
  ...
  ["deals.destincondogetaways.com", "/deals"],
  ["explore.destincondogetaways.com", null],
  ["offer.destincondogetaways.com", "/offer"],
  ["sunbirds.destincondogetaways.com", "/snowbird"],
]);

const exploreRoutes = new Map([
  ["/destin-hub", "/destin-hub"],
  ["/destin-hub.html", "/destin-hub"],
  ["/destin-tripshock.html", "/activities"],
  ["/destin-car-rental.html", "/car-rentals"],
]);
...
export function cleanInternalLinksInHtml(html = "") {
  return html.replace(/href=(['"])(https?:\/\/[^'"]+)\1/gi, (match, quote, href) => `href=${quote}${cleanInternalUrl(href)}${quote}`);
}
