...
export default function DestinLiveMusicGuide() {
  const structuredData = { "@context": "https://schema.org", "@graph": [
    ...
    { "@type": "Article", headline: article.h1, description: article.description, image: liveSite + "/hub-music.webp", mainEntityOfPage: canonical, author: { "@type": "Person", name: "Ozan CILI" }, publisher: { "@type": "Organization", name: "Destin Condo Getaways", url: liveSite } },
