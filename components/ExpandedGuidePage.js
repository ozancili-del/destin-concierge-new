...
export default function ExpandedGuidePage({ slug }) {
  ...
  const structuredData = {"@context":"https://schema.org","@graph":[
    {"@type":"BlogPosting","@id":`${canonical}#article`,headline:guide.title,description:guide.description,image:`${liveSite}${guide.image}`,datePublished:guide.published,dateModified:"2026-08-16",author:{"@type":"Person",name:"Ozan CILI"},publisher:{"@type":"Organization","@id":`${liveSite}/#business`,name:"Destin Condo Getaways",url:liveSite},mainEntityOfPage:{"@id":`${canonical}#webpage`}},
  ...
  const body = <div className={guideStyles.guide}>
    <p className={guideStyles.byline}>By Ozan CILI, owner of Destin Condo Getaways · Thoroughly updated August 2026</p>
