    ...
    <>
      ...
      <style jsx global>{`
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .sbux-tag-img { position:absolute; bottom:8px; right:25px; z-index:3; width:clamp(60px,20%,90px); pointer-events:none; filter:drop-shadow(0 6px 14px rgba(0,0,0,0.6)); }
