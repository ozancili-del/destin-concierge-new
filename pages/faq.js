...
export default function FAQ() {
  const schema = { "@context": "https://schema.org", "@graph": [
    { "@type": "FAQPage", "@id": `${liveSite}/faq#webpage`, url: `${liveSite}/faq`, name: "Destin Condo Getaways Frequently Asked Questions", mainEntity: faqs.map(([question, answer]) => ({ "@type": "Question", name: question, acceptedAnswer: { "@type": "Answer", text: answer } })) },
    { "@type": "BreadcrumbList", itemListElement: [{ "@type": "ListItem", position: 1, name: "Home", item: liveSite }, { "@type": "ListItem", position: 2, name: "FAQ", item: `${liveSite}/faq` }] },
  ] };
  return <div className={styles.page}>
    <Head><title>Destin Condo Rental FAQ | Pelican Beach Resort</title><meta name="description" content="Answers about direct booking, Unit 707, Unit 1006, Pelican Beach Resort, occupancy, check-in, amenities, trip planning and guest support."/><meta name="robots" content="noindex,nofollow"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="canonical" href={`${liveSite}/faq`}/><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(schema) }}/></Head>
