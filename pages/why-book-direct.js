...
export default function WhyBookDirect() {
  ...
  return (
    <div className={styles.page}>
      <Head>
        <title>Book Direct at Pelican Beach Resort | Destin Condo Getaways</title>
      ...
      <main>
        ...
        <section className={styles.related}><div className={styles.sectionIntro}><p className={styles.kicker}>Continue planning</p><h2>Useful details for the whole Destin stay.</h2></div><div className={styles.relatedGrid}><a href="/pelican-beach-resort-destin"><span>Resort guide</span><strong>Pools, beach access and location</strong></a><a href="/destin-condo-rental-reviews"><span>Guest reviews</span><strong>Read recent stay experiences</strong></a><a href="/beach-cam"><span>Live beach cam</span><strong>See the Gulf before you arrive</strong></a><a href="/blog/best-restaurants-destin"><span>Dining guide</span><strong>Plan seafood and family meals</strong></a><a href="/blog/destinweather"><span>Weather guide</span><strong>Know what each season brings</strong></a><a href="/destin-vacation-itinerary-planner"><span>Trip planner</span><strong>Create a personalized itinerary</strong></a></div></section>
