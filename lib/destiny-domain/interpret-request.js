...
function requestedFields(text, category) {
  ...
  if (/\bev\b|electric vehicle|j1772/.test(value) && /\bprice|fee|cost|charging\b/.test(value)) return ["session_fee", "energy_fee", "idle_fee", "idle_cap", "idle_exemption"];
...
export function interpretRouterInput(input) {
  ...
  return Object.freeze({
    ...
    expectedSlot: expectedField && expectedNumber !== null ? Object.freeze({ field: expectedField, value: expectedNumber }) : null,
