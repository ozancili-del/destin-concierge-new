...
const IMPLICIT_MULTI_CHOICE_RE = /\b(?:restaurants|beaches|activities|attractions|shops|shopping|groceries|supermarkets|spas|airports)\b/i;
...
const QUERY_TOPIC_RULES = Object.freeze([
  ...
  ["restaurants", /\b(?:restaurants?|dining|dinner|lunch|breakfast|brunch|italian|seafood|pizza|pasta|sushi|steaks?|places? to eat|where to eat|eateries|food)\b/i],
