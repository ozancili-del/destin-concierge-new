...
export default function ReviewsPage() {
  ...
  return <div className={styles.page}>
    ...
    <div className={styles.utility}><a href="/reviews">Guest Reviews</a><a href="/resort#faq">FAQ</a><a href={liveSite + "/destin-condo-guide-574047967"}>Policies</a><a href={liveSite + "/aboutus-574000712"}>Contact</a></div>
    ...
    <footer className={styles.footer}><div className={styles.footerBrand}><strong>Destin Condo Getaways</strong><p>Two beachfront condos. Thoughtful owner-direct hospitality.</p><a href="tel:+19723574262">(972) 357-4262</a><a href="mailto:ozan@destincondogetaways.com">ozan@destincondogetaways.com</a><address>1002 US-98<br/>Destin, FL 32541</address></div><div><strong>Stay</strong><a href={liveSite + "/pelican-beach-resort-unit-707-orp5b47b5ax"}>Unit 707</a><a href={liveSite + "/pelican-beach-resort-unit-1006-orp5b6450ex"}>Unit 1006</a><a href="#availability">Availability</a><a href="/reviews">Reviews</a><a href="/why-book-direct">Book direct</a></div><div><strong>Plan</strong><a href={liveSite + "/blog/how-to-find-cheaper-flights-and-car-rentals"}>Flights</a><a href={liveSite + "/blog/destincar"}>Car rentals</a><a href="https://explore.destincondogetaways.com/destin-tripshock.html">Activities</a><a href={liveSite + "/destin-vacation-itinerary-planner-574049367"}>Itinerary planner</a><a href={liveSite + "/map"}>Destin map</a></div><div><strong>Destin Guides</strong><a href={liveSite + "/blog/destinweather"}>Weather</a><a href={liveSite + "/blog/best-beaches-destin"}>Beaches</a><a href={liveSite + "/blog/best-restaurants-destin"}>Restaurants</a><a href={liveSite + "/blog/destin-events-2026"}>Events</a><a href={liveSite + "/blog/destin-fireworks-2026"}>Fireworks</a></div><div><strong>Guest Information</strong><a href={liveSite + "/destin-condo-guide-574047967"}>Policies</a><a href="/resort#faq">FAQ</a><a href={liveSite + "/aboutus-574000712"}>Contact</a><a href={liveSite + "/privacy-574035022"}>Privacy</a><a href={liveSite + "/destin-live-beach-cam-574002656"}>Live beach cam</a></div></footer>
