...
function bookingInputFromArgs(args, context, { allowZeroChildBaseline = false } = {}) {
  ...
  const holidayStay = !dateAmbiguous && args.date_confidence !== "explicit" && exactTextAppears(args.holiday_evidence, latestUser)
    ? resolveHolidayStay(args.holiday_name, now)
    : null;
