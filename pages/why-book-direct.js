...
const reasons = [
  ...
  { number: "04", title: "More vacation, fewer platform fees", copy: "Direct booking avoids the separate guest service fee commonly added by large vacation-rental marketplaces. OwnerRez automatically applies the current 10% direct-booking discount, and the resulting price is reflected during secure checkout." },
];
...
export default function WhyBookDirect() {
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.utility}><a href={`${liveSite}/reviews`}>Guest Reviews</a><a href="#direct-faq">FAQ</a><a href="/guest-guide">Policies</a><a href={`${liveSite}/aboutus-574000712`}>Contact</a></div>
