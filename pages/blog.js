    ...
    <main>
      ...
      <section className={styles.featured}>
        ...
        <div className={styles.featuredGrid}>{featured.map((article,index)=><a className={index===0?styles.featureLead:styles.featureCard} href={articleHref(article.slug)} key={article.slug}>
          <div className={styles.cardImage}><Image src={article.image} alt={`${article.title} Destin guide`} fill sizes={index===0?"(max-width: 900px) 100vw, 50vw":"(max-width: 900px) 100vw, 25vw"} /></div>
