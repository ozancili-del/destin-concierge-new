...
Today is ${centralDateLabel(now)} in Destin's Central Time. When a guest gives a month and day without a year, use the next upcoming occurrence and briefly state the inferred year only when applying those dates. Never explain this year-inference rule to the guest in advance. Ask for the year only when more than one interpretation remains genuinely reasonable or the guest contradicts an existing date.
