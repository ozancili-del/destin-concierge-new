...
export default function DestinEventsGuide() {
  const structuredData = { "@context": "https://schema.org", "@graph": [
    ...
    { "@type": "Article", headline: article.h1, description: article.description, image: liveSite + "/hub-events.png", mainEntityOfPage: canonical, author: { "@type": "Person", name: "Ozan CILI" }, publisher: { "@type": "Organization", name: "Destin Condo Getaways", url: liveSite } },
  ...
  return <MigratedBlogArticle pageTitle="Destin Events Calendar 2026 | Festivals & Activities" description={article.description} structuredData={structuredData} heroImage="/hub-events.png" heroAlt="Destin events, festivals and waterfront celebrations" kicker="Updated 2026 events calendar" title="Destin Events Calendar 2026" intro="Plan around festivals, fishing events, food celebrations, concerts and the major seasonal happenings across Destin and the Emerald Coast." articleHtml={article.html} related={[
