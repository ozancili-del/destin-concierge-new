...
export default function MapPage() {
  ...
  return <div className={styles.page}>
    ...
    <main>
      ...
      <AvailabilitySearch />
      <section className={styles.mapSection}><div className={styles.mapCopy}><p className={styles.kicker}>Pelican Beach Resort</p><h2>1002 US-98, Destin, FL 32541</h2><p>Our vacation rentals are in the resort&apos;s main Gulf-front building. Guests can take the elevator to beach level and walk directly onto the sand without crossing a road.</p><div><a href="/pelican-beach-resort-unit-707"><strong>Unit 707</strong><span>Seventh-floor Gulf view →</span></a><a href="/pelican-beach-resort-unit-1006"><strong>Unit 1006</strong><span>Tenth-floor panoramic view →</span></a></div></div><iframe title="Google Map showing Pelican Beach Resort in Destin Florida" loading="lazy" referrerPolicy="no-referrer-when-downgrade" src={mapEmbed}/></section>
