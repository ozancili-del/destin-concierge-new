...
export default function SiteFooter() {
  return <footer className={styles.footer}>
    ...
    <div><strong>Plan</strong><a href="/destin-ai-concierge">Destin AI concierge</a><a href="/trip-planner">Trip planner</a><a href="/car-rentals">Flights &amp; rental cars</a><a href="/activities">Activities</a><a href="/deals">Beach deals</a><a href="/snowbird">Snowbird stays</a></div>
