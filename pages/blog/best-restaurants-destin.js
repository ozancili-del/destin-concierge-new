...
export default function DestinSeafoodGuide() {
  ...
  return <MigratedBlogArticle pageTitle="Best Seafood Restaurants in Destin Florida | 2026 Guide" description={article.description} structuredData={structuredData} heroImage="/hub-seafood.png" heroAlt="Fresh seafood dining in Destin Florida" kicker="Seafood and waterfront dining" title="Best Seafood Restaurants in Destin" intro="Honest local picks for casual beachfront seafood, harbor favorites and fine dining—with distances and an interactive map." articleHtml={article.html} related={[
