  ...
  try {
    ...
    if (name === "search_current_events") {
      ...
      const facts = [
        ...
        `Answer with no more than three concise, relevant options for ${requestedArea}. Include verified listings first. Useful but incompletely verified leads may still be included, labeled naturally as needing a date/time cross-check. Never call an unverified listing confirmed. End with one short reminder to check the linked page because schedules can change.`,
