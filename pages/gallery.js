...
export default function Gallery() {
  ...
  return <div className={styles.page}>
    ...
    {process.env.NEXT_PUBLIC_DEPLOYMENT_ENV !== "production" ? <div className={styles.preview}>Migration preview | The current live website remains unchanged</div> : null}<SiteHeader availabilityHref="#availability" />
