...
export const VOICE_TOOL_PROGRESS_SILENCE_MS = 6500;
export const VOICE_TOOL_PROGRESS_FALLBACK_MS = 11000;
...
export function voiceProgressInstructions(label) {
  ...
  return `Say exactly this one warm progress update and nothing else: “Checking ${safeLabel} is taking a little longer than I expected, but I’m still working on it. Thanks for bearing with me.”`;
}
