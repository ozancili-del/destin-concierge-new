  ...
  return <div className={styles.page}>
    ...
    <main>
      ...
      <section className={styles.context}>
        <div className={styles.contextImage}><Image src="/destin-resorts-coastline.webp" alt="Pelican Beach Resort beachfront setting in Destin" fill sizes="(max-width: 900px) 100vw, 44vw" /></div>
