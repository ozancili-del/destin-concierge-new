  ...
  },
  {
    ...
    function: {
      ...
      parameters: {
        ...
        required: ["date_text", "date_role", "arrival", "departure", "adults", "adults_evidence", "children", "children_evidence", "total_guests", "total_guests_evidence", "party_scope", "party_evidence", "preferred_unit", "bedrooms_requested", "bedrooms_evidence"],
      },
    },
  },
  {
    ...
    function: {
      ...
      parameters: {
        ...
        required: ["date_text", "arrival", "departure", "adults", "adults_evidence", "children", "children_evidence", "total_guests", "total_guests_evidence", "party_scope", "party_evidence", "preferred_unit", "bedrooms_requested", "bedrooms_evidence"],
      },
    },
  },
  {
    ...
    function: {
      ...
      parameters: {
        ...
        required: ["target_date_text", "target_arrival", "target_departure", "flexibility_days", "adults", "adults_evidence", "children", "children_evidence", "total_guests", "total_guests_evidence", "party_scope", "party_evidence"],
      },
    },
  },
  {
...
function bookingInputFromArgs(args, context, { allowZeroChildBaseline = false } = {}) {
  ...
  const modelScopedAdultParty = args.party_scope === "current_trip" && evidenceAppears(args.party_evidence, latestUser) && explicitAdults !== null && args.children === null;
  ...
  return { dates, adults, children, totalGuests, preferredUnit, bedroomsRequested, explicitAdults, explicitChildren, explicitTotalGuests, assumedChildrenZero, dateText, dateAmbiguous, partyAmbiguous };
}
...
export async function runAgentTurn({
  ...
  if (!reply || !validation.ok) {
    ...
    reply = needsPartyClarification
      ...
      : availabilityFallback || safeFallback({ state: workingState, latestUser, reason: validation.violations?.[0]?.code || agentError || "agent_failure" });
  }
