...
export default function GuestGuidePage() {
  ...
  return <div className={styles.page}>
    ...
    <header className={styles.header}>
      ...
      <nav aria-label="Main navigation"><a href="/#condos">Condos</a><a href="/resort">The Resort</a><a href={liveSite + "/blog"}>Destin Guide</a><a href={liveSite + "/destin-live-beach-cam-574002656"}>Beach Cam</a><a href="https://deals.destincondogetaways.com/beach-deals">Deals</a><a href="#faq">FAQ</a></nav>
