...
export default function handler(req,res){return orderedMemoryEnabled()?serveOrderedPreview('chat',req,res):process.env.VERCEL_ENV==='preview'?servePrivateWeb('chat',req,res):servePrivate('chat',req,res);}
