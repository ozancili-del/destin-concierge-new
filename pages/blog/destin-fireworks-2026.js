...
export default function DestinFireworksGuide() {
  const structuredData = { "@context": "https://schema.org", "@graph": [
    ...
    { "@type": "Article", headline: article.h1, description: article.description, image: liveSite + "/fireworks-harborwalk.png", mainEntityOfPage: canonical, author: { "@type": "Person", name: "Ozan CILI" }, publisher: { "@type": "Organization", name: "Destin Condo Getaways", url: liveSite } },
  ...
  return <MigratedBlogArticle pageTitle="Destin Fireworks 2026 | Schedule, Locations & Map" description={article.description} structuredData={structuredData} heroImage="/fireworks-harborwalk.png" heroAlt="Fireworks over Destin Harbor and the Emerald Coast" kicker="2026 schedule and viewing guide" title="Destin Fireworks 2026" intro="Find fireworks dates, viewing locations, directions, parking advice and the interactive July 4 map in one locally researched guide." articleHtml={article.html} related={[
    { label: "Events", title: "Destin events in 2026", href: liveSite + "/blog/destin-events-2026" },
